        ...
        return (
            <div className="Korisnik-page">
                ...
                <div className="login-container">
                    <FormGroup label="Korisnicko Ime" name="username" key="username" value={this.state.username} onChange={this.onChange} />
                    <FormGroup label="Password" name="password" key="password" type="password" value={this.state.password} onChange={this.onChange} />
